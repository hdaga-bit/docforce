...
Package version `1.3.0` and System Model schema version `1.0.0` are independent numbers.

| Version | What it means |
|---------|----------------|
| `@mary/docforce` 1.3.0 | Tool / npm package (Professional Technical Architecture Document Composer) |
